...
export declare abstract class BaseAdapter {
     ...
     */
    abstract bind(manager: LavalinkManager): void;
    /**
     * Should return the bot's ID.
     */
    abstract getBotId(): Snowflake;
    /**
     ...
     */
    abstract hasPerms(guildId: Snowflake, channelId?: Snowflake): Promise<Permissions> | Permissions;
    /**
     ...
     */
    abstract isStage(channelId: Snowflake): Promise<boolean> | boolean;
    /**
     ...
     */
    abstract modifyCurrentUserVoiceState(guildId: Snowflake, data: RESTPatchAPIGuildVoiceStateCurrentMemberJSONBody): Promise<void> | void;
    /**
     ...
     */
    abstract updateVoiceState(data: GatewayVoiceStateUpdateData): Promise<void> | void;
}
