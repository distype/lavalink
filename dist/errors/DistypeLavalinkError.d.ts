 ...
 */
export declare type DistypeLavalinkErrorSystem = `Lavalink Manager` | `Lavalink Node ${number}` | `Lavalink Player ${Snowflake}`;
/**
 * The type of error that has ocurred.
 */
export declare enum DistypeLavalinkErrorType {
    /**
 ...
 */
export declare class DistypeLavalinkError extends Error {
    /**
     * The type of error that has ocurred.
     */
    readonly errorType: DistypeLavalinkErrorType;
    /**
     * The system the error was emitted from.
     */
    readonly system: DistypeLavalinkErrorSystem;
    /**
